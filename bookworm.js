...
BookwormClasses = {
    ...
    streamgraph : function() {
        ...
        bands
            .attr("d", area)
            .style("fill", function(d) {return bookworm.scales.color(d[0][query.aesthetic.fill]); });
    ...
    timeHandler: function(timeHandler,callback) {
        ...
        timeHandler.timeSlider = function() {
            ...
            timeHandler.axis = d3.svg.axis().scale(timeHandler.axisScale).orient("bottom").tickFormat(function(d) {return d}).ticks(20)
    ...
    "makeAxisAndScale" : function(axis,limits,sortBy,descending) {
        ...
        function updateOrder() {
            ...
            if (sortBy == "value") {
                value = function(keyname) {return d3.median(lookup[keyname].map(function(d) {return d[query.aesthetic.x]}))}
...
Bookworm = function(query) {
    ...
    //A bookworm is initializaed with a query.
    var newBookworm;
